...
<body>
	<div id="center-content">
		...
		<div class="content-form">
			<form:form method="post" commandName="group_bean" class="frame" id="edit_group">
				...
				<div class="field-group">
					<fieldset>
						<legend>
							<%-- <fmt:message key="servicelevel.showNewServiceLevelForm.legend" /> --%>Edit Group Information
						</legend>
						<div class="field">
							<div class="label-box">
								<%-- <fmt:message
							...
							<div class="input-box">
								<form:input path="agr_code" id="srvShort" maxlength="60" readonly="true"/>
